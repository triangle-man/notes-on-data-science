...
- This is part three of my on-again, off-again series of talks about
  functional programming.  I don't think I've got it right yet but I
  have enjoyed thinking about these so thank you for giving me the
  opportunity to talk again.

- In this talk I'd like to show you a little bit about what it is like
  to program in a functional way.  My plan is to do that by writing a
  functional program to solve a programming challenge.

- Functional programming can seem strange and unusual when you first
  see it. It can feel too abstract, perhaps, or anyway disconnected
  from the reality of the computer. I think perhaps that these is the
  same way many people feel when they first encounter programming of
  any kind. I hope that by the end of the talk I'll have given you a
  flavour of what it's like to approach programming from this
  perspective.

- First of all, why functions?

- Although it seems ridiculous, I'd like you to forget, for a moment,
  that real, physical, computers exist. I want to ask, what is a
  computation actually /for/?
...
- Functional programming is about making useful functions out of
  simpler ones. 
...
I will use OCaml, a language with a strong functional core. OCaml is
quite pragmatic -- there are imperative features too.
